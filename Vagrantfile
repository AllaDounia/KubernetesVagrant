...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_url = "http://#{UPDATE_CHANNEL}.release.core-os.net/amd64-usr/#{COREOS_VERSION}/coreos_production_vagrant.json"
  ...
  config.vm.define vm_proxy_name = "proxy" do |proxy|
    ...
    proxy.vm.box = "precise64"
    proxy.vm.box_url = "http://files.vagrantup.com/precise64.box"
